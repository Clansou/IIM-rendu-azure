...
function createUser(request, context) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, pseudo, email, querySpec, users, resource, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (users.length > 0) {
                        return [2 /*return*/, { status: 409, body: "Utilisateur déjà existant." }];
                    }
                    return [4 /*yield*/, usersContainer.items.create({ pseudo: pseudo, email: email })];
                case 4:
                    resource = (_b.sent()).resource;
                    return [2 /*return*/, { status: 201, body: JSON.stringify(resource) }];
                case 5:
                    err_1 = _b.sent();
                    return [2 /*return*/, { status: 500, body: "Erreur lors de la création de l'utilisateur." }];
