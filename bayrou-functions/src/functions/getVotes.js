...
function getVotes(request, context) {
    return __awaiter(this, void 0, void 0, function () {
        var querySpec, votes, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, { status: 200, body: JSON.stringify(votes) }];
                case 3:
                    err_1 = _a.sent();
                    context.log("Erreur lors de la récupération des votes:", err_1);
                    return [2 /*return*/, { status: 500, body: "Erreur lors de la récupération des votes." }];
